export default async function handler(req, res) {
  ...
  console.log("GEMINI_API_KEY primi 10 caratteri:", GEMINI_API_KEY ? GEMINI_API_KEY.substring(0, 10) : "MANCA");
  ...
  console.log("URL (senza chiave):", url.substring(0, url.indexOf('key=')));
